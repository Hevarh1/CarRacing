...
from model_updates import PolicyUpdate
...
if __name__ == "__main__":
    import argparse
    from core import solve, create_models, make_env
    from baselines import GAEBaseline, DiscountedReturnBaseline
    from model_updates import ActorCriticUpdate, ValueUpdate
